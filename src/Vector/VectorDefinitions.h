...
template <typename T> size_t Vector<T>::max_size() const { return max_size_; }
...
template <typename T> T *Vector<T>::data() { return values_; }

template <typename T> const T *Vector<T>::data() const { return values_; }
